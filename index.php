        ...
        <main>
           <div class="container">
                <div class="slide-wrapper">
                    <div class="slider">
                        <img id="s1" src="assets/slider/2.jpg" alt="">
                        <img id="s2" src="assets/slider/3.jpg" alt="">
                        <img id="s3" src="assets/slider/4.jpg" alt="">
                        <img id="s4" src="assets/slider/11.jpg" alt="">
                    </div>
            ...
            <div id="featuredproduct" class="featured-products">
            ...
            <div style="display: flex; flex: 1 1 210px; flex-wrap: wrap; margin: auto; justify-content: center;">
                ...
                ?>
                    ...
                    <a href="details.php?product_id=<?php echo $d01["product_id"]; ?>&name=products">
